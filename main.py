...
def home_page():
    ...
    def home():
        ...
        price_label = Label(home_frame, text=total_bal, font=('Bebas Neue', 55), justify='center', bg="#e9e9e6")
        price_label.place(x=362, y=280, anchor="center")

        def display():
            cursor3.execute("SELECT item_name, platform, date_arrival, "
                            "price FROM records.list ORDER BY date_arrival ASC LIMIT 4")
    ...
    def order_page():
        ...
        def sort_arrival_asc():
            ...
            if cb_1.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.list ORDER BY date_arrival ASC ")
                ...
                cursor4.execute("SELECT * FROM records.list")
                results_my_cursor_2 = cursor4.fetchall()
        ...
        def sort_arrival_desc():
            ...
            if cb_2.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.list ORDER BY date_arrival DESC ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def sort_price_asc():
            ...
            if cb_3.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.list ORDER BY price ASC ")
                results_my_cursor_2 = cursor4.fetchall()
        ...
        def sort_price_desc():
            ...
            if cb_4.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.list ORDER BY price DESC ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def group_platform():
            ...
            if cb_5.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.list ORDER BY platform ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def search():
            ...
            cursor6 = con6.cursor()
            cursor6.execute("select * from records.list where order_id= '" + search_box.get() + "'")
        ...
        def delete_data(order_id):
            ...
            if my_var:  # True if yes button is clicked
                ...
                cursor5.execute("DELETE FROM records.list WHERE order_id=" + str(order_id))
        ...
        def update_data():  # update record
            ...
            mycursor2.execute("UPDATE records.list SET item_name=%s,platform=%s,\
                                     quantity=%s,date_ordered=%s, date_arrival=%s, price=%s WHERE order_id = %s", data)
    ...
    def history_page():
        ...
        def sort_arrival_asc():
            ...
            if cb_1.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.history ORDER BY date_arrival ASC ")
                results_my_cursor_2 = cursor4.fetchall()
                ...
                cursor4.execute("SELECT * FROM records.history")
                results_my_cursor_2 = cursor4.fetchall()
        ...
        def sort_arrival_desc():
            ...
            if cb_2.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.history ORDER BY date_arrival DESC ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def sort_price_asc():
            ...
            if cb_3.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.history ORDER BY price ASC ")
                results_my_cursor_2 = cursor4.fetchall()
        ...
        def sort_price_desc():
            ...
            if cb_4.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.history ORDER BY price DESC ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def group_platform():
            ...
            if cb_5.get() == 1:
                ...
                cursor4.execute("SELECT * FROM records.history ORDER BY platform ")
                results_my_cursor_2 = cursor4.fetchall()
                i = 0
                for x in results_my_cursor_2:  # Displaying The Table
                    for j in range(len(x)):
        ...
        def search():
            ...
            cursor6 = con6.cursor()
            cursor6.execute(
                "SELECT * FROM records.history WHERE item_name LIKE CONCAT ('%', '" + search_data + "', '%')")
            results_my_cursor_3 = cursor6.fetchall()
        ...
        def delete_history(item_name):
            ...
            if my_var2:  # True if yes button is clicked
                cursor7.execute("DELETE FROM records.history WHERE item_name=" + item_name)
...
start_btn = Button(landing_frame, image=start_bt, command=home_page, font=('arial', 10), bd=0, bg="#40647b")
start_btn.place(x=965, y=380)
